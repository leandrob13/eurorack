...
#ifndef MARBLES_GRIDS_GRIDS_RESOURCES_H_
#define MARBLES_GRIDS_GRIDS_RESOURCES_H_
...
extern const uint16_t* const grids_lookup_table_table[];

extern const uint32_t* const lookup_table32_table[];

extern const uint8_t* const node_table[];

extern const uint32_t grids_lut_res_euclidean[];
extern const uint32_t grids_lut_res_tempo_phase_increment[];
...
#endif  // MARBLES_GRIDS_GRIDS_RESOURCES_H_
